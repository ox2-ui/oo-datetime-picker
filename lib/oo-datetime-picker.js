...
Template.ooDatetimePicker.helpers({
  ...
  activeMinute : function () {
   return typeof Template.instance().ooMinutes.get() === 'number' ? Template.instance().ooMinutes.get() : '--'
  },
  //
  //      hour helpers
  //
  ...
  activeHour : function () {
    return typeof Template.instance().ooHours.get() === 'number' ? Template.instance().ooHours.get() : '--'
  },
